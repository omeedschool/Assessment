...
class Game(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title_label = tk.Label(self.frame, text="Trivia Turbo", font=("Helvetica", 24))
        self.title_label.place(relx=0.5, rely=0.06, anchor=tk.CENTER)

        # Set up question and answer display for Player 1
        self.player1_frame = tk.Frame(self.frame, bd=5, relief=tk.RAISED, padx=10, pady=10)
        self.player1_frame.place(relx=0.5, rely=0.30, anchor=tk.CENTER, width=500, height=300)

        self.question_label = tk.Label(self.player1_frame, text="", font=("Helvetica", 16))
        self.question_label.place(relx=0.5, rely=0.20, anchor=tk.CENTER)
        
        self.answer_labels = [
            tk.Label(self.player1_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player1_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player1_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player1_frame, text="", font=("Helvetica", 16))
        ]
        ...
        self.player2_frame = tk.Frame(self.frame, bd=5, relief=tk.RAISED, padx=10, pady=10)
        self.player2_frame.place(relx=0.5, rely=0.75, anchor=tk.CENTER, width=500, height=300)

        self.question_label_2 = tk.Label(self.player2_frame, text="", font=("Helvetica", 16))
        self.question_label_2.place(relx=0.5, rely=0.20, anchor=tk.CENTER)

        self.answer_labels_2 = [
            tk.Label(self.player2_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player2_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player2_frame, text="", font=("Helvetica", 16)),
            tk.Label(self.player2_frame, text="", font=("Helvetica", 16))
        ]
