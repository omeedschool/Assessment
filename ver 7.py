...
NORMAL_TEXT_FONT = ("Terminal", 20)
TITLE_TEXT_FONT = ("Terminal", 30)
...
class Game(tk.Tk):
    ...
    def __init__(self):
        ...
        # Create a background Canvas widget
        self.background_canvas = tk.Canvas(self, width=RESOLUTION[0], height=RESOLUTION[1])
        self.background_canvas.pack(fill=tk.BOTH, expand=True)

        # Load and display the background image
        self.bg_image_photo = tk.PhotoImage(file="cars/background.png")
        self.bg_image = self.background_canvas.create_image(0, 0, anchor=tk.NW, image=self.bg_image_photo)

        # Create a Canvas widget for moving elements
        self.canvas = tk.Canvas(self.background_canvas, width=400, height=800)
        ...
        # Title Label
        self.title_label = tk.Label(self.background_canvas, text="Trivia Turbo", font=TITLE_TEXT_FONT, background="#ef476f", borderwidth=3, relief="solid", padx=50, pady=5)
        self.title_label.place(x=300, y=50, anchor=tk.CENTER)

        # Set up question and answer display for Player 1
        self.player1_frame = tk.Frame(self.background_canvas, padx=10, pady=10, relief="solid", borderwidth=3)
        ...
        self.player2_frame = tk.Frame(self.background_canvas, padx=10, pady=10, relief="solid", borderwidth=3)
